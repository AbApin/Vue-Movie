  ...
  <div class="relative flex items-center gap-5">
    ...
    >
      <ul v-if="searchResult.length != 0">
        <li v-for="searchMovie in searchResult" :key="searchMovie.id">
          <router-link
            :to="{ name: 'movie', params: { id: searchMovie.id } }"
            @click.native="searchResultDivStyle"
...
<script>
import AcountDropdown from './AcountDropdown.vue';
