...
export default {
  ...
  computed: {
    posterPath() {
      return 'https://image.tmdb.org/t/p/original/' + this.currentMovie.poster_path;
    },
    playTrailer() {
      if (!this.currentMovie.videos) return;
      return 'https://www.youtube.com/embed/' + this.currentMovie.videos.results[0].key;
    },
  },
  watch: {
