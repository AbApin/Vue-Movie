<template>
  <div class="relative flex items-center gap-5">
    ...
    <div class="absolute top-14 left-0 w-full max-w-[80%] rounded bg-gray-600 pl-2">
      ...
      <ul v-if="notResultFound" class="px-3 py-3">
        <li class="te">No result found for "{{ searchValue }}"</li>
      </ul>
    </div>
  ...
  methods: {
    ...
    async fetchSearch(value) {
      try {
        ...
        this.notResultFound = response.data.results ? true : false;
