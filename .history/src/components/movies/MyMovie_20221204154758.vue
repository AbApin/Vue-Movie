<template>
  <div class="container mx-auto">
      ...
      <div class="ml-24">
        ...
        <div class="flex items-center gap-1">
          ...
          <span class="text-sm text-gray-500"
            >{{ Math.round(this.CURRENT_MOVIE.vote_average * 10) }}% |
            {{ this.CURRENT_MOVIE.release_date }} {{ CURRENT_MOVIE_GENRES.join(',') }}</span
          >
        </div>
        <p class="mt-5">
        ...
        <div class="mt-5">
          ...
          <div class="flex">
            <div v-for="(crew, index) in this.CURRENT_MOVIE.credits.crew" :key="index">
    ...
    <div class="border-b border-gray-600 py-4">
      ...
      <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        <MovieImagesItem
          v-for="image in this.CURRENT_MOVIE.images.backdrops"
          :key="image.file_path"
          :image="image"
...
export default {
  ...
  beforeCreate() {
    console.log(this.CURRENT_MOVIE);
  },
  created() {
    window.scrollTo({
      top: 0,
  ...
  mounted() {
    console.log(this.CURRENT_MOVIE.poster_path);
  },
  methods: {
