<template>
  <div class="container mx-auto">
    <div class="mt-20 flex border-b border-gray-600 pb-2">
      ...
      <div class="ml-24">
        <h1 class="text-4xl font-semibold">{{ currentMovie.title }}</h1>
        <div class="flex items-center gap-1">
          ...
          <span class="text-sm text-gray-500"
            >{{ Math.round(currentMovie.vote_average * 10) }}% | {{ currentMovie.release_date }}
            {{ movieGenres.join(',') }}</span
          >
        </div>
        <p class="mt-5">
          {{ this.currentMovie.overview }}
        </p>
        <div class="mt-5">
          <span class="mt-5 font-semibold">Featured Cast</span>
          <div class="flex">
            <div v-for="(crew, index) in currentMovie.credits.crew" :key="index">
    ...
    <div class="border-b border-gray-600 py-4">
      ...
      <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        <CastItem v-for="cast in currentMovie.credits.cast" :key="cast.cast_id" :cast="cast" />
      </div>
    </div>
    <!-- casts-end -->
...
export default {
  ...
  methods: {
    ...mapActions(['FETCH_CURRENT_MOVIE', 'FETCH_GENRES']),
    openTrailerModel() {
  ...
  computed: {
    ...
    getMovieImages() {
      return this.currentMovie.images.backdrops;
    },
  },
  watch: {
    '$route.params.id': {
      immediate: true,
      handler(newValue) {
        this.fetchCurrentMovie(newValue);
      },
    },
  },
};
